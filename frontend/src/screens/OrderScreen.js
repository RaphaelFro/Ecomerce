          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Raph</p>
                <p>
                  <a href={`mailto:admin@example.com`}>raph@example.com</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>Méthode de paiement: Paypal</p>

                <div className="bg-info p-2 col-12">
                  <p className="text-white text-center text-sm-start">
                  Payé le 15 Juillet 2022
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-4 mb-lg-4 mb-5 mb-sm-0">
            <div className="row">
              ...
              <div className="col-md-8 center">
                ...
                <p>
                  Addresse: 12056 Paramount Blvd, Downey, CA 90242, États-Unis
                </p>
